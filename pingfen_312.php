...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/pingfen_312.css" />
        ...
        <div class="swiper-container" id="mySwiper">
            <div class="swiper-wrapper">
                ...
                <div id="slide-ques1" class="swiper-slide pagethree swiper-no-swiping">
                    <div class="pagethree-1 option" data-val="1" data-name="《中国24》"></div>
                    <div class="pagethree-2 option" data-val="2" data-name="《民生与民意》"></div>
                    <div class="pagethree-3 option" data-val="3" data-name="《世界观察》"></div>
                    <div class="pagethree-4 option" data-val="4" data-name="《全球财经》"></div>
                    <div class="pagethree-5 option" data-val="5" data-name="《新闻一小时》"></div>
                    <img id="js-btn-ques1" class="btn" src="img/3.7/btn.png"/>
                </div>
                <div id="slide-ques2" class="swiper-slide pagefour swiper-no-swiping">
                    <div class="pagefour-1 option" data-val="1" data-name="Twitter"></div>
                    <div class="pagefour-2 option" data-val="2" data-name="YouTube"></div>
                    <div class="pagefour-3 option" data-val="3" data-name="Facebook"></div>
                 	<div class="pagefour-4 option" data-val="4" data-name="CCTV news"></div>
                    <img id="js-btn-ques2" class="btn" src="img/3.7/btn.png"/>
                </div>
                <div id="slide-ques3" class="swiper-slide pagefive swiper-no-swiping">
                	<div class="pagefive-1 option" data-val="1" data-name="卢威"></div>
                    <div class="pagefive-2 option" data-val="2" data-name="RianMaelzer"></div>
                    <div class="pagefive-3 option" data-val="3" data-name="田薇"></div>
                 	<div class="pagefive-4 option" data-val="4" data-name="韩斌"></div>
                    <img id="js-btn-ques3" class="btn" src="img/3.7/btn.png"/>
                </div>
                <div id="slide-ques4" class="swiper-slide pagesix swiper-no-swiping">
                    <div class="pagesix-1 option" data-val="1" data-name="韩斌"></div>
                    <div class="pagesix-2 option" data-val="2" data-name="田薇"></div>
                    <div class="pagesix-3 option" data-val="3" data-name="杨诚曦"></div>
                    <div class="pagesix-4 option" data-val="4" data-name="韩鹏"></div>
                    <img id="js-btn-ques4" class="btn" src="img/3.7/btn.png"/>
                </div>
                <div id="slide-ques5" class="swiper-slide pageseven swiper-no-swiping">
                    <div class="pageseven-1 option" data-val="1" data-name="中国文化与软实力建设"></div>
                    <div class="pageseven-2 option" data-val="2" data-name="关注中国外交"></div>
                    <div class="pageseven-3 option" data-val="3" data-name="关注环保"></div>
                    <div class="pageseven-4 option" data-val="4" data-name="采访姚明"></div>
                    <img id="js-btn-ques5" class="btn" src="img/3.7/btn.png"/>
                </div>
                <div id="slide-ques6" class="swiper-slide pageeight swiper-no-swiping">
                    <div class="pageeight-1 option" data-val="1" data-name="虚拟技术"></div>
                    <div class="pageeight-2 option" data-val="2" data-name="NPC&CPPCC科普短片"></div>
                    <div class="pageeight-3 option" data-val="3" data-name="字版"></div>
                    <div class="pageeight-4 option" data-val="4" data-name="图表"></div>
        ...
        <script type="text/javascript">
            ...
            wx.ready(function() {
                ...
                wx.onMenuShareAppMessage({
                    ...
                    link: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb1e05fcce8f01cb8&redirect_uri=http://h5.quapp.net/cctv/pingfen_312.php&response_type=code&scope=snsapi_base#wechat_redirect', // 分享链接
            ...
            $("#js-btn-ques1").click(function(){
                $("#slide-ques1 .on").each(function(){
                    ...
                    wx_monkv.pushFormData('ques1', 'multi', selected_val);
...
//                    alert('selected ' + selected_val);
            ...
            $("#js-btn-ques5").click(function(){
                $("#slide-ques5 .on").each(function(){
                    var selected_val = $(this).data('val');
                    wx_monkv.pushFormData('ques5', 'multi', selected_val);
//                    alert('selected ' + selected_val);
                });
            });
            ...
            $("#js-btn-ques6").click(function(){
                $("#slide-ques6 .on").each(function(){
                    var selected_val = $(this).data('val');
                    wx_monkv.pushFormData('ques6', 'multi', selected_val);
//                    alert('selected ' + selected_val);
                });
                wx_monkv.submitForm('pingfen_312_dev', function(data){
                    console.log(data);
                    showResults();
                });
