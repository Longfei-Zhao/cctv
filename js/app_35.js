		    ...
		    onSlideChangeEnd : function(){
		    	...
		    	switch ( mySwiper.activeIndex )
		    	{
		    		...
		    		case 2:
		    			...
		    			$(".pagethree-1").addClass('animated flipInX');
		    			$(".pagethree-2").addClass('animated flipInX');
		    			$(".pagethree-3").addClass('animated zoomIn');
		    		...
		    		case 3:
		    			...
		    			$(".pagefour-1").addClass('animated flipInX');
		    			$(".pagefour-2").addClass('animated flipInX');
		    			$(".pagefour-3").addClass('animated flipInX');
		    			$(".pagefour-4").addClass('animated fadeInLeft');
		    			$(".pagefour-5").addClass('animated fadeInRight');
		    			$(".pagefour-6").addClass('animated zoomIn');
		    			$(".pagefour-7").addClass('animated fadeInLeft');
		    			$(".pagefour-8").addClass('animated fadeInRight');
		    			$(".pagefour-9").addClass('animated fadeInLeft');
		    			$(".pagefour-10").addClass('animated fadeInRight');
		    			$(".pagefour-11").addClass('animated fadeInUp');
		    			$(".pagefour-12").addClass('animated fadeInUp');
		    			$(".pagefour-13").addClass('animated fadeInUp');
		    			break;
	    			case 4:
